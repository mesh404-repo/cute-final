"""Extra media tools - crop_image, read_image, image_info.

Includes PNM (PPM/PGM/PBM) helpers and read_image for preparing/downscaling
...
# ---------------------------------------------------------------------------
# read_image: prepare/downscale/convert images for vision, then attach
# ---------------------------------------------------------------------------
