...
from agent.tools.registry import ExecutorConfig, ExecutorStats, ToolRegistry
...
class AgentExecutor:
    ...
    def assess_risk(
        ...
        if tool_name in ("read_file", "list_dir", "grep_files", "analyze_image", "extract_video_frames", "extract_keyframes", "web_search"):
