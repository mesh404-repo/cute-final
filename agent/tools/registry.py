...
class ToolRegistry:
    ...
    def _get_process_runner(self) -> Any:
        ...
        if self._process_runner is None:
            from agent.tools.process import ProcessToolRunner
...
""",
    ...
    def _execute_analyze_image(self, cwd: Path, args: dict[str, Any]) -> ToolResult:
        ...
        from agent.tools.analyze_image import analyze_image as run_analyze_image
    ...
    def _execute_extract_video_frames(self, cwd: Path, args: dict[str, Any]) -> ToolResult:
        ...
        from agent.tools.extract_video import extract_video_frames
    ...
    def _execute_extract_keyframes(self, cwd: Path, args: dict[str, Any]) -> ToolResult:
        ...
        from agent.tools.extract_video import extract_keyframes
...
Be thorough, complete, and accurate. Missing even one item or getting spelling/formatting wrong will cause failure."""
    ...
    def _execute_wait_for_port(self, args: dict[str, Any]) -> ToolResult:
        ...
        from agent.tools.process import run_wait_for_port
    ...
    def _execute_wait_for_file(self, args: dict[str, Any]) -> ToolResult:
        ...
        from agent.tools.process import run_wait_for_file
    ...
    def _execute_run_until_file(self, cwd: Path, args: dict[str, Any]) -> ToolResult:
        ...
        from agent.tools.process import run_run_until_file
    ...
    def _execute_image_info(self, cwd: Path, args: dict[str, Any]) -> ToolResult:
        ...
        from agent.tools.media_extra import run_image_info
